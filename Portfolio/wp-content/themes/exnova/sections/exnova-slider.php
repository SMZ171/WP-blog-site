<?php 
	$exnova_hs_slider		= get_theme_mod('hide_show_slider','on');
	if( $exnova_hs_slider == 'on' ): 
?>
...
<?php if(!empty($id_arr))
{ ?>
	<section id="slider-section" class="slider-wrapper slider-section-exnova">
		<div class="main-slider arrows-small arrows-transparent">
			...
			<div class="item">
				...
				<div class="specia-slider <?php echo esc_attr(get_post_meta( get_the_ID(),'slider_caption_align', true)); ?>" style="background: rgba(255,255,255,0.9);">
					<div class="specia-table">
                        <div class="specia-table-cell">
                            <div class="container">                                
                                <div class="specia-content">
										<h1 data-animation="fadeInUp" data-delay="350ms"><?php echo wp_filter_post_kses($title); ?><span></span></h1>
